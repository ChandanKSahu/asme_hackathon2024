...
class ImageDataset(Dataset):
    def __init__(self, data_dict:dict, num_pos=50000, num_neg=50000):
...
class MissingImageCNN(nn.Module):
    def __init__(self, dropout=0.4):
        super(MissingImageCNN, self).__init__()
...
model = MissingImageCNN(dropout=dropout)
