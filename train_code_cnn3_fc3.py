...
class MissingImageCNN3FC3(nn.Module):
    def __init__(self, dropout=0.4):
        super(MissingImageCNN3FC3, self).__init__()
...
lr = 0.0001
weight_decay = 0.001 # .0001 #.001# .0001 # .001 # .001 # 1e-3
num_epochs = 75
dropout = 0.4

#%%
### model initialization
model = MissingImageCNN3FC3(dropout=dropout)
...
os.rename("cnn_missing_images.pt", f"missing_images_CNN3FC3{save_string}.pt")
